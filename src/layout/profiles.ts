...
export const QUEST_PRO_PROFILE: DeviceProfile = {
  ...
  renderMetrics: {
    ...
    paragraph: paragraphMetrics(0.024, 1.3, 0.0001),
    heading: {
      1: paragraphMetrics(0.044, 1.3, 0.015),
      2: paragraphMetrics(0.034, 1.35, 0.015),
      3: paragraphMetrics(0.027, 1.4, 0.01),
      4: paragraphMetrics(0.024, 1.4, 0.01),
      5: paragraphMetrics(0.022, 1.45, 0.01),
      6: paragraphMetrics(0.02, 1.45, 0.01),
    },
...
export const RAY_BAN_META_PROFILE: DeviceProfile = {
  ...
  renderMetrics: {
    paragraph: paragraphMetrics(0.018, 1.35, 0.0001, 0.55, 5.5),
    heading: {
      1: paragraphMetrics(0.03, 1.3, 0.01),
      2: paragraphMetrics(0.025, 1.35, 0.01),
      3: paragraphMetrics(0.02, 1.4, 0.007),
      4: paragraphMetrics(0.018, 1.4, 0.007),
      5: paragraphMetrics(0.016, 1.45, 0.007),
      6: paragraphMetrics(0.015, 1.45, 0.007),
    },
    ...
    listItem: textBearing(0.035, 0.015),
    listItemContentPad: 0.007,
    listItemProseInset: 0.007,
    listItemMinPad: 0.004,
    listItemWrapCushion: 0.006,
