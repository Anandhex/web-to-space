...
export const METRIC_DESCRIPTIONS: Record<string, string> = {
  ...
  // XR Layout & Usability
  "Layout template":
    "Scene archetype auto-selected by the layout engine based on landmark counts, control density, and content volume. Determines spatial slot arrangement. Options: document, landing, generic.",
  "Primitives placed":
